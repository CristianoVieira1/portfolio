              ...
              <div className="my-skill-area-left-content-wrap">
                <div className="section-head text-align-left">
                  <div className="section-sub-title tmp-scroll-trigger tmp-fade-in animation-order-1">
                    <span className="subtitle">Stack principal</span>
                  </div>
                  ...
                  <p className="description tmp-scroll-trigger tmp-fade-in animation-order-3">
                    Escolho ferramentas modernas e consolidadas para entregar
                    aplicações com melhor manutenção, qualidade e velocidade de
                    evolução.
                  </p>
                </div>
              </div>
